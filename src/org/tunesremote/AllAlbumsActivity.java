            ...
            public void run() {
               ...
               try {
                  if (resp.containsKey("minm")) {
                     results.add(resp);
                     nice.add(Normalizer.normalize(resp.getString("minm"), Normalizer.Form.NFKD).replaceAll(
   ...
   private class LoadPhotoTask extends AsyncTask<Object, Void, Object[]> {
      ...
      protected void onPostExecute(Object[] result) {
         try {
            ...
            if (!stored)
               v.startAnimation(AnimationUtils.loadAnimation(AllAlbumsActivity.this, R.anim.fade_up));
