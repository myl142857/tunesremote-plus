...
public class AllAlbumsActivity extends BaseBrowseActivity {
	...
	public Handler resultsUpdated = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			Animation fadeDown = AnimationUtils.loadAnimation(AllAlbumsActivity.this, R.anim.fade_down);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		imageSize = imageSize > 110 ? 110 : imageSize;
		...
		this.getListView().setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				try {
					...
					Intent intent = new Intent(AllAlbumsActivity.this, TracksActivity.class);
					...
					AllAlbumsActivity.this.startActivityForResult(intent, 1);
				} catch (Exception e) {
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
		...
		try {
			...
			getMenuInflater().inflate(R.menu.context_albums, menu);
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		try {
			...
			if (id == R.id.context_album_play) {
				...
				AllAlbumsActivity.this.setResult(RESULT_OK, new Intent());
	...
	private class LoadPhotoTask extends AsyncTask<Object, Void, Object[]> {
		...
		protected void onPostExecute(Object[] result) {
			try {
				...
				if (!stored) v.startAnimation(AnimationUtils.loadAnimation(AllAlbumsActivity.this, R.anim.fade_up));
