...
public class ArtistsActivity extends BaseBrowseActivity {
    ...
    * letter. Independent to {@link scrollAlpha} so the {@link ArtistsAdapter}
    * can use it too.
   ...
   public int walkToLetter(int section) {
      ...
      if (cachedSections.get(section) != null)
         return cachedSections.get(section);
   ...
   public int getSectionFromPos(int position) {
      ...
      while (startsWith(index) == prefix && index > 0)
         index--;
   ...
   public class ArtistsAdapter extends BaseAdapter implements TagListener, SectionIndexer {
      ...
      public ArtistsAdapter(Context context) {
         ...
         // Set up alphabetSections, done in code because it's fiddly to do by
         // hand
