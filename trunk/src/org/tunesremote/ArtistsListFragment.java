...
public class ArtistsListFragment extends ListFragment implements
	...
	/*TODO: If we're not using the Alphabet scroller,
	* remove all the references to the "nice" list,
	...
	*/
    ...
    public void onCreate(Bundle saved) {
        ...
        if (adapter == null) adapter = new ArtistsAdapter(getActivity());
    ...
    public void onServiceConnected() {
        ...
        if (host != null) {
            if (adapter == null) adapter = new ArtistsAdapter(host);
    ...
    public Handler resultsUpdated = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (getView() != null) {
                ...
                if (isVisible() && host.positionViewed == 0) setListShown(true);
                    ...
                    try {
                        ...
                        if (resp.containsKey("mlit")) {
                            ...
                            if (mlit.length() > 0 && !mlit.startsWith("mshc")) {
                                results.add(resp);
//                                nice.add(Normalizer.normalize(mlit.replaceAll("The ", "")
